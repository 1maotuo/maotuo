...
STOP_REASON_STALE_RETRY_LIMIT_REACHED = "stale_retry_limit_reached"
...
class TaskState:
    ...
    def stop_stale_retry_limit(self, final_answer=""):
        """记录证据过期重试耗尽，供报告和评测区分普通步数耗尽。"""
        return self.stop(STOP_REASON_STALE_RETRY_LIMIT_REACHED, status=STATUS_FAILED, final_answer=final_answer)
